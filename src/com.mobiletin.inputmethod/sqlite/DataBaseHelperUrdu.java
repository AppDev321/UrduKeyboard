 ...
 */
public class DataBaseHelperUrdu extends SQLiteOpenHelper {
    static String DATABASE_PATH ="";// "/data/data/"++"/databases/";
    static String DATABASE_NAME = "next_word.sqlite";
    static int DATABASE_VERSION = 1;
    SQLiteDatabase db;
     Context mContext;


    public DataBaseHelperUrdu(Context context) {
    ...
    public void createDataBase() throws IOException {
        ...
        if (!mDataBaseExist) {
            ...
            try {
                ...
                throw new Error("Error copying database--- urdu");
            } finally {
                this.close();
            }
        }
